...
上記のような都合で作成されたプログラムのため、Outlook(web版)で直接CSV
...
Windows用 : Windowsバッチファイル
  ...
  sjis-gen-202509.csv : 2025年9月のスケジュール
  sjis-gen-202510.csv : 2025年10月のスケジュール
  sjis-gen-all.csv    : すべてのスケジュール

Linux,macOS用: Shellスクリプト

  $ sh samplegen.sh

  ShiftJISのファイルに追加してUTF-8のファイルが生成されます。

  utf8-gen-202509.csv : 2025年9月のスケジュール
  utf8-gen-202510.csv : 2025年10月のスケジュール
  utf8-gen-all.csv    : すべてのスケジュール
...
※2025年9月と10月のスケジュールが無い場合は空のファイルが生成されます。
